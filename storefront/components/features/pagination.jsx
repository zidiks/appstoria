            ...
            {totalPage > 1 &&
                <ul className="pagination">
                    <li className={`page-item ${page < 2 ? 'disabled' : ''}`}>
                        <ALink className="page-link page-link-prev" href={page > 1 ? {pathname: pagedPathname(props.fullPath, page - 1), query: { ...query } } : '#'} scroll={false}>
                    ...
                    <li className={`page-item ${page > totalPage - 1 ? 'disabled' : ''}`}>
                        <ALink className="page-link page-link-next" href={page < totalPage ? {pathname: pagedPathname(props.fullPath, page + 1), query: { ...query } } : '#'} scroll={false}>
